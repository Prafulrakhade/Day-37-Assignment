...
namespace AddressBookSystem
{
    ...
    public class AddressBookClass
    {
        ...
        {
            string json = File.ReadAllText(@"D:\Bridgelabz-145\Assignments_\Day 37\AddressBookSystem\AddressBookSystem\ContactsDetails.json");
            if (json.Length > 0)
            {
        ...
        public void addPerson(Person p)
        {
            ...
            File.WriteAllText(@"D:\Bridgelabz-145\Assignments_\Day 37\AddressBookSystem\AddressBookSystem\ContactsDetails.json", jsonData);
        }
